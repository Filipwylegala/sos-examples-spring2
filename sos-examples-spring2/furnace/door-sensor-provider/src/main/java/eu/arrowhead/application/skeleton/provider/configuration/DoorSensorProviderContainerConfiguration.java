...
@Configuration
public class DoorSensorProviderContainerConfiguration implements WebServerFactoryCustomizer<TomcatServletWebServerFactory>  {
	
	//=================================================================================================
	// members
	
	@Autowired
    DoorSensorProviderContainerConfProperties doorSensorProviderContainerConfProperties;
	
	private final Logger log = LogManager.getLogger( DoorSensorProviderContainerConfiguration.class);
	...
	public void customize(TomcatServletWebServerFactory factory) {
		 factory.addConnectorCustomizers(connector -> {
	            ...
	            protocol.setMaxKeepAliveRequests(doorSensorProviderContainerConfProperties.getMaxKeepAliveRequests());
