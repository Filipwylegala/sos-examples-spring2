...
@Configuration
@EnableWebSecurity
public class DoorSensorProviderProviderSecurityConfig extends DefaultSecurityConfig {
	...
	private DoorSensorProviderTokenSecurityFilter tokenSecurityFilter;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		if (tokenSecurityFilterEnabled) {
			tokenSecurityFilter = new DoorSensorProviderTokenSecurityFilter();
			http.addFilterAfter(tokenSecurityFilter, SecurityContextHolderAwareRequestFilter.class);			
		}
	}

	//-------------------------------------------------------------------------------------------------
	public DoorSensorProviderTokenSecurityFilter getTokenSecurityFilter() {
