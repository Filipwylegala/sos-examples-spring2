...
@Configuration
public class TemperatureSensorProviderContainerConfiguration implements WebServerFactoryCustomizer<TomcatServletWebServerFactory>  {
	
	//=================================================================================================
	// members
	
	@Autowired
    TemperatureSensorProviderContainerConfProperties temperatureSensorProviderContainerConfProperties;
	
	private final Logger log = LogManager.getLogger( TemperatureSensorProviderContainerConfiguration.class);
	...
	public void customize(TomcatServletWebServerFactory factory) {
		 factory.addConnectorCustomizers(connector -> {
	            ...
	            protocol.setMaxKeepAliveRequests(temperatureSensorProviderContainerConfProperties.getMaxKeepAliveRequests());
