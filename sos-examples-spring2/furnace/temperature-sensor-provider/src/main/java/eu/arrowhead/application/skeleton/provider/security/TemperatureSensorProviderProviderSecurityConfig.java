...
@Configuration
@EnableWebSecurity
public class TemperatureSensorProviderProviderSecurityConfig extends DefaultSecurityConfig {
	...
	private TemperatureSensorProviderTokenSecurityFilter tokenSecurityFilter;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		if (tokenSecurityFilterEnabled) {
			tokenSecurityFilter = new TemperatureSensorProviderTokenSecurityFilter();
			http.addFilterAfter(tokenSecurityFilter, SecurityContextHolderAwareRequestFilter.class);			
		}
	}

	//-------------------------------------------------------------------------------------------------
	public TemperatureSensorProviderTokenSecurityFilter getTokenSecurityFilter() {
