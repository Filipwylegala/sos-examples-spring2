...
@Validated
public class TemperatureSensorProviderContainerConfProperties {

	//=================================================================================================
	// members
	
	@Min(TemperatureSensorProviderConfigConstants.MIN_MAXKEEPALIVE_REQUESTS)
	@Max(TemperatureSensorProviderConfigConstants.MAX_MAXKEEPALIVE_REQUESTS)
