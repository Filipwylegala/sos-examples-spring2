...
@Validated
public class HeatingSystemProviderContainerConfProperties {

	//=================================================================================================
	// members
	
	@Min(HeatingSystemProviderConfigConstants.MIN_MAXKEEPALIVE_REQUESTS)
	@Max(HeatingSystemProviderConfigConstants.MAX_MAXKEEPALIVE_REQUESTS)
