...
@Configuration
public class HeatingSystemProviderContainerConfiguration implements WebServerFactoryCustomizer<TomcatServletWebServerFactory>  {
	
	//=================================================================================================
	// members
	
	@Autowired
	HeatingSystemProviderContainerConfProperties heatingSystemProviderContainerConfProperties;
	
	private final Logger log = LogManager.getLogger( HeatingSystemProviderContainerConfiguration.class);
	...
	public void customize(TomcatServletWebServerFactory factory) {
		 factory.addConnectorCustomizers(connector -> {
	            ...
	            protocol.setMaxKeepAliveRequests(heatingSystemProviderContainerConfProperties.getMaxKeepAliveRequests());
